...
public class listagemVIEW extends javax.swing.JFrame {
    ...
    private void btnVenderActionPerformed(java.awt.event.ActionEvent evt) {                                          
        String id = id_produto_venda.getText(); // Obtém o ID do produto
    if (id.isEmpty()) {
    ...
    boolean sucesso = produtosdao.venderProduto(Integer.parseInt(id)); // Marca o produto como vendido
    
    if (sucesso) {
        JOptionPane.showMessageDialog(this, "Produto vendido com sucesso.");
        listarProdutos(); // Atualiza a tabela para refletir a venda
    } else {
    ...
    // Torna a tela de vendas visível
    telaVendas.setVisible(true);
    
    // Opcionalmente, você pode esconder a tela atual (listagemVIEW)

...
public class listagemVIEW extends javax.swing.JFrame {
    ...
    private void listarProdutos(){
        try {
            ...
            // Suponha que produtosdao.listarProdutos() retorne uma lista de objetos Produto
            ArrayList<ProdutosDTO> listagem = produtosdao.listarProdutos(); 

            // Aqui você substitui pela lógica que usa o produtoController
            List<Produto> produtos = produtoController.listarProdutos();  // Obtém os produtos

            for (Produto p : produtos) {
                model.addRow(new Object[]{
                    p.getId(),   // ID do produto
                    p.getNome(), // Nome do produto
                    p.getPreco(), // Preço do produto
                    p.getStatus() // Status do produto
                });
            }
        } catch (Exception e) {
            e.printStackTrace(); // Trata o erro caso ocorra
        }
    }
}

...
public class cadastroVIEW extends javax.swing.JFrame {
    ...
    private void btnCadastrarActionPerformed(java.awt.event.ActionEvent evt) {                                             
        ...
        try {
            ...
            produto.setValor(preco); // agora o valor é um double
            produto.setStatus("A Venda");

            // Instancia o DAO para salvar o produto
            ProdutosDAO produtodao = new ProdutosDAO();
            boolean sucesso = produtodao.cadastrarProduto(produto);

            // Verifica o sucesso da operação e exibe uma mensagem
            if (sucesso) {
            ...
            // Trata o erro caso o valor não seja um número válido
            JOptionPane.showMessageDialog(this, "Valor inválido! Por favor, insira um número válido para o preço.");
        }
    }                                            
